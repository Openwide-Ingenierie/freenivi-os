...
echo -e "${CYAN}################################################################################${NC}"
echo -e "${CYAN}#                                                                              #${NC}"
echo -e "${CYAN}#    ${BLUE}Freenivi OS build system - (c) OpenWide Ingénierie                  ${CYAN}#${NC}"
echo -e "${CYAN}#                                                                              #${NC}"
echo -e "${CYAN}################################################################################${NC}"
echo ""
...
echo "       nitrogen6x:    Support for arm imx6 Boundary device evaluation board."
echo "       raspberrypi:   Support for the now famous embedded board Rapsberry PI"
echo " "
